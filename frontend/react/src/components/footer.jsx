...
const navigation = {
    ...
    social: [
        ...
        {
            name: 'LinkedIn',
            href: 'https://www.linkedin.com/company/enshrouded-technologies-llc/',
            icon: (props) => (
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="currentColor" {...props}>
                    <path
...
export default function Footer(props) {
    const { photoCredit, isWhite } = props;
    return (
        <footer className="bg-slate-900" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-sm leading-6 text-gray-300">
                            Creating technical products that excel
                        </p>
                ...
                <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-xs leading-5 text-gray-400">&copy; {new Date().getFullYear()} &middot; <Link to="/"> Enshrouded Technologies LLC </Link></p>
                    {photoCredit &&
                        <p
                        ...
                        >
                            ...
                            {` See Their`} <Link className="underline" to={photoCredit?.galleryLink}> Gallery </Link>
                        </p>
                    }
                </div>
            </div>
